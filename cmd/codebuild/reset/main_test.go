...
import (
	...
	commonMocks "github.com/rismail1980/dce/pkg/common/mocks"
	"github.com/rismail1980/dce/pkg/db"
	"github.com/rismail1980/dce/pkg/db/mocks"
...
func TestResetPipeline(t *testing.T) {
	...
	t.Run("testNukeConfigGeneration", func(t *testing.T) {
		...
		_config = &serviceConfig{
			...
			nukeRegions:                []string{"us-east-1", "eu-west-1"},
